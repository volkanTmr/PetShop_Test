...
public class Negative_Senarios {
    ...
    // BU BÖLÜMDE NEGATİF SONUÇLAR AMAÇLADIM

    // BU TESTİMDE URI ADRESİNİ EKSİK GİREREK 404 ALMAYI HEDEFLEDİM
    @Test
    public void Pet_POST_Test() throws URISyntaxException, IOException, InterruptedException {
        ...
        HttpRequest postRequest = HttpRequest.newBuilder()
                .uri(new URI("https://petstore.swagger.io/v2/"))
    ...
    // BU TESTTE header("Content-Type", "application/json") , HEADER KALDIRILARAK 415 HATASI ALMAYI AMAÇLADIM
    ...
    // GET TESTİNDE OLMAYAN BİR ÖĞE ÇAĞRILARAK 404 ALMAYI AMAÇLADIM
    ...
    public void Pet_Get_Test_WithId() throws URISyntaxException, IOException, InterruptedException {
        ...
        HttpRequest getRequest = HttpRequest.newBuilder()
                .uri(new URI("https://petstore.swagger.io/v2/pet/965478" + pet.getId()))
                .header("Authorization", key).
    ...
    // YANLIŞ BİR ÇAĞRI ŞEKLİ İLE 405 KODU ALMAK AMAÇ

    @Test
    public void Pet_Get_Test_WithStatus() throws URISyntaxException, IOException, InterruptedException {
